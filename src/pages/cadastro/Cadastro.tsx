    ...
    return (
        <>
            <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
                ...
                <form className="flex justify-center items-center flex-col w-2/3 gap-4 p-8"
                ...
                >
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <input
                            ...
                            className="border-2 border-(--persian-rose-300) rounded-xl p-3
                                     focus:border-(--persian-rose-500)s:outline-none
                                     transition-all duration-300"
                            value={usuario.foto}
                            onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)}
                        />
                    ...
                    <div className="flex justify-around w-full gap-4 mt-4">
                        <button
                            type="reset"
                            className="rounded-xl text-white bg-linear-to-r from-gray-400 
