...
function CardTema({ tema }: CardTemaProps) {
    return (
        <div className='border-2 border-(--yellow-400) flex flex-col rounded-2xl 
            ...
            <header className='py-3 px-6 bg-linear-to-r from-(--yellow-400) 
            ...
            <p className='p-8 text-2xl font-semibold text-(--persian-rose-800) 
                        bg-linear-to-br from-(--yellow-200) to-white h-full 
            ...
            <div className="flex">
                <Link to={`/editartema/${tema.id}`}
                    className='w-full text-white bg-linear-to-r from-(--persian-rose-400) 
                ...
                <Link to={`/deletartema/${tema.id}`} 
                    className='text-white bg-linear-to-r from-(--persian-rose-600) 
